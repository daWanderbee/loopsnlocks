            ...
            <Card isBlurred="true" className="max-w-md w-full bg-darkPink shadow-lg rounded-lg p-6 flex flex-col items-center">
                ...
                <CardBody>
                    <form className="space-y-4">
                        ...
                        <button type="submit" className="w-full bg-darkPink text-white py-2 px-4 rounded-md hover:bg-lightPink hover:text-darkPink transition duration-200 border-1 border-black">Sign In</button>
                ...
                <CardFooter className="text-center mt-4 justify-center mx-auto  p-4">
                    <p className="text-sm text-gray-800">Don't have an account? <a href="/sign-up" className="text-darkPurple hover:underline">Sign Up</a></p>
                </CardFooter>
            </Card>
        </div>
